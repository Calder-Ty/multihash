// Copyright (c) 2023 Rene Schallner, MIT License
// Copyright (c) 2024 Tyler Calder, MIT License

const std = @import("std");
const multihash = @import("./root.zig");
...
const multihash_function = multihash.HashFunction.sha2_256;

// The length of the Digest is known because we
